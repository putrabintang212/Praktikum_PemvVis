...
Public Class Produk_Laptop
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Select Case ComboBox1.SelectedItem.ToString()
            Case "Laptop"
                Dim pl As New Produk_Laptop()
                pl.Show()
                Me.Hide() ' Jika ingin form saat ini disembunyikan

            Case "Keyboard"
                Dim pk As New Produk_Keyboard()
                pk.Show()
                Me.Close()

            Case "Mouse"
                Dim pm As New Produk_Mouse()
                pm.Show()
                Me.Close()
        End Select
    End Sub
